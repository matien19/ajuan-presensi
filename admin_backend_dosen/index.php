                  ...
                  <div class="col-lg-12">
                    <div class="card">
                      <div class="card-header" style="background-color:#86090f">
                        <font color="ffffff">
                          <h3 class="card-title"><i class="nav-icon fas fa-user"></i> Data Dosen</h3>
                      </div>
                      </font>
                      <!-- /.card-header -->
                      <div class="card-body">
                        ...
                        <!-- <a href="reset.php" class="btn btn-danger" onclick="return confirm('Anda akan menghapus seluruh data Dosen ?')">
                          ...
                          <tbody>
                            ...
                            ?>
                                <tr>
                                  ...
                                  <td>
                                    <center>
                                      <h6>
                                        ...
                                        <a href="https://wa.me/<?= $data['kontak']; ?>" class="btn btn-success btn-sm" target="blank">
                                  ...
                                  <td>
                                    <center>
                                      <a href="resetpw.php?nid=<?= $data['nid']; ?>" class="btn btn-warning btn-sm" onclick="return confirm('Anda akan mereset password Dosen [ <?= $data['nid'] . ' - ' . $data['nama'];  ?> ]?')">
                                      ...
                                      ?>
                                      <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-editdata" data-nid="<?= $data['nid']; ?>" data-nama="<?= $data['nama']; ?>" data-kelamin="<?= $kelamin2; ?>" data-nohp="<?= $data['kontak']; ?>" data-status="<?= $status2 ?>">
                                        <i class="fas fa-edit"></i>
                                        Edit
                                      </button>

                                      <a href="delete.php?id=<?= $encodeid; ?>&real=<?= $data['nid']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Anda akan menghapus data dosen [ <?= $data['nid'] . ' - ' . $data['nama']; ?> ] ?')">
                ...
                <form class="form-horizontal" action="create.php" method="POST">
                  <div class="modal-body">
                    <div class="form-group">
                      ...
                      <input type="number" name="nid" class="form-control" placeholder="Masukan NID">
                    </div>
                    <div class="form-group">
      ...
      <div class="modal-content">
        ...
        <form class="form-horizontal" action="update.php" method="POST">
          <div class="modal-body">
            <div class="form-group">
              <label for="nid">NID</label>
              <input type="number" name="nid" class="form-control" disabled>
              <input type="number" name="nid2" class="form-control" hidden>
            </div>
            <div class="form-group">
              <label for="Nama">Nama</label>
              <input type="text" name="nama" class="form-control" placeholder="Masukan Nama">
