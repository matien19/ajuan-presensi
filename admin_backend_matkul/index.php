                ...
                <form class="form-horizontal" action="create.php" method="POST">
                  <div class="modal-body">
                    <div class="form-group">
                      ...
                      <input type="text" name="kd_matkul" class="form-control" placeholder="Masukan Kode Mata kuliah" required>
                    </div>
                    <div class="form-group">
                      <label for="Nama">Nama Indonesia</label>
                      <input type="text" name="nama_ind" class="form-control" placeholder="Masukan Nama Indonesia" required>
                    </div>
                    <div class="form-group">
                      <label for="nama_eng">Nama Inggris</label>
                      <input type="text" name="nama_eng" class="form-control" placeholder="Masukan kontak Inggris" required>
                    </div>
                    <div class="form-group">
                      <label for="sks">Jumlah SKS</label>
                      <input type="text" name="sks" class="form-control" placeholder="Masukan jumlah SKS" required>
                    </div>
                  </div>
