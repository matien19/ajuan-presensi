...
<body>
  <div class="wrapper" style="zoom:90%" !important>
    ...
    if (isset($_POST['tambahdata'])) {
      ...
      $querycek_klsmk =  mysqli_query($con, "SELECT * FROM tbl_klsmatkul WHERE kode_matkul='$kode_mk' AND nid='$nid' AND kelas='$kelas' AND kode_jurusan='$jurusan' ") or die(mysqli_eror($con));
      ...
      if (mysqli_num_rows($querycek_klsmk) > 0) {
        ...
        mysqli_query($con, "INSERT INTO tbl_klsmatkul VALUES (NULL,'$nid','$kode_mk','$kelas','$jurusan')") or die(mysqli_eror($con));
        echo '
        <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
        <script>
